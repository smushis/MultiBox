...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow, app):
        ...
        self.cadreProfil = QtWidgets.QLabel(self.centralwidget)
        self.cadreProfil.setGeometry(QtCore.QRect(60, 30, 351, 441))
        self.cadreProfil.setText("")
        self.cadreProfil.setPixmap(QtGui.QPixmap("img/PS4-Tranquility-(Avatar-Border).png"))
        self.cadreProfil.setObjectName("cadreProfil")
