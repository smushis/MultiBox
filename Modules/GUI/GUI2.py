...
class Ui_MainWindow(object): 
    ...
    def setupUi(self, MainWindow, app):
        ...
        self.stats_artist.setGeometry(QtCore.QRect(570, 290, 111, 411))
        font = QtGui.QFont()
        font.setPointSize(12)
