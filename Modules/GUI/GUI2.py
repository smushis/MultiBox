...
class Ui_MainWindow(object): 
    ...
    def setupUi(self, MainWindow, app):
        ...
        self.data_1.setAlignment(QtCore.Qt.AlignLeading|QtCore.Qt.AlignLeft|QtCore.Qt.AlignVCenter)
        ...
        self.data_2.setAlignment(QtCore.Qt.AlignLeading|QtCore.Qt.AlignLeft|QtCore.Qt.AlignVCenter)
        ...
        self.data_3.setAlignment(QtCore.Qt.AlignLeading|QtCore.Qt.AlignLeft|QtCore.Qt.AlignVCenter)
        ...
        self.data_4.setAlignment(QtCore.Qt.AlignLeading|QtCore.Qt.AlignLeft|QtCore.Qt.AlignVCenter)
        ...
        self.raspi_temp.setGeometry(QtCore.QRect(20, 430, 161, 21))
        font = QtGui.QFont()
        ...
        self.progressBar.setGeometry(QtCore.QRect(10, 350, 131, 31))
        ...
        self.progressBar_2.setGeometry(QtCore.QRect(10, 395, 131, 31))
        ...
        self.raspi_ram_2.setGeometry(QtCore.QRect(4, 350, 141, 41))
        ...
        self.raspi_cpu_2.setGeometry(QtCore.QRect(10, 395, 131, 31))
        ...
        self.cadreDataRaspi.setGeometry(QtCore.QRect(0, 320, 201, 161))
        ...
        self.rank_rl_1.setGeometry(QtCore.QRect(165, 234, 51, 41))
        ...
        self.rank_rl_1.setPalette(palette)
        font = QtGui.QFont()
        font.setPointSize(10)
        font.setBold(True)
        font.setWeight(75)
        ...
        self.cadreRL.setGeometry(QtCore.QRect(150, 188, 151, 161))
        ...
        self.rl_3v3.setGeometry(QtCore.QRect(160, 218, 51, 31))
        font = QtGui.QFont()
        ...
        self.rl_2v2.setGeometry(QtCore.QRect(160, 264, 71, 51))
        font = QtGui.QFont()
        font.setPointSize(16)
        font.setBold(True)
        font.setWeight(75)
        ...
        self.rl_rank_img_1.setGeometry(QtCore.QRect(220, 218, 61, 51))
        self.rl_rank_img_1.setText("")
        self.rl_rank_img_1.setPixmap(QtGui.QPixmap("img/GUI2/RL/Diamond III.png"))
        self.rl_rank_img_1.setObjectName("rl_rank_img_1")
        self.rl_rank_img_2 = QtWidgets.QLabel(self.centralwidget)
        self.rl_rank_img_2.setGeometry(QtCore.QRect(220, 268, 61, 51))
        self.rl_rank_img_2.setText("")
        self.rl_rank_img_2.setPixmap(QtGui.QPixmap("img/GUI2/RL/Diamond III.png"))
        self.rl_rank_img_2.setObjectName("rl_rank_img_2")
        self.rank_rl_2 = QtWidgets.QLabel(self.centralwidget)
        self.rank_rl_2.setGeometry(QtCore.QRect(165, 303, 51, 21))
        palette = QtGui.QPalette()
        brush = QtGui.QBrush(QtGui.QColor(244, 16, 0))
        brush.setStyle(QtCore.Qt.SolidPattern)
        palette.setBrush(QtGui.QPalette.Active, QtGui.QPalette.WindowText, brush)
        brush = QtGui.QBrush(QtGui.QColor(244, 16, 0))
        brush.setStyle(QtCore.Qt.SolidPattern)
        ...
        brush.setStyle(QtCore.Qt.SolidPattern)
        palette.setBrush(QtGui.QPalette.Disabled, QtGui.QPalette.WindowText, brush)
        self.rank_rl_2.setPalette(palette)
        font = QtGui.QFont()
        font.setPointSize(10)
        font.setBold(True)
        font.setWeight(75)
        ...
        self.raspi_cpu_img.setGeometry(QtCore.QRect(146, 400, 41, 21))
        font = QtGui.QFont()
        font.setPointSize(12)
        font.setBold(True)
        font.setWeight(75)
        ...
        self.raspi_ram_img.setGeometry(QtCore.QRect(142, 357, 51, 21))
        font = QtGui.QFont()
        font.setPointSize(12)
        font.setBold(True)
        font.setWeight(75)
        ...
        self.quote.setGeometry(QtCore.QRect(310, 210, 551, 121))
        font = QtGui.QFont()
        font.setFamily("Segoe Script")
        font.setPointSize(16)
        self.quote.setFont(font)
        self.quote.setTextFormat(QtCore.Qt.AutoText)
