...
class Ui_MainWindow(object): 
    ...
    def setupUi(self, MainWindow, app):
        ...
        self.titleMusic.setGeometry(QtCore.QRect(250, 579, 211, 31))
        font = QtGui.QFont()
        ...
        self.artistMusic.setGeometry(QtCore.QRect(251, 623, 221, 41))
        font = QtGui.QFont()
        font.setFamily("Arial")
        font.setPointSize(12)
        ...
        self.raspi_RAM.setGeometry(QtCore.QRect(190, 355, 151, 31))
        font = QtGui.QFont()
        font.setPointSize(20)
        font.setBold(True)
        font.setWeight(75)
        self.raspi_RAM.setFont(font)
        self.raspi_RAM.setAlignment(QtCore.Qt.AlignCenter)
        self.raspi_RAM.setObjectName("raspi_RAM")
        self.raspi_CPU = QtWidgets.QLabel(self.centralwidget)
        self.raspi_CPU.setGeometry(QtCore.QRect(190, 393, 161, 51))
        font = QtGui.QFont()
        font.setPointSize(20)
        font.setBold(True)
        font.setWeight(75)
        self.raspi_CPU.setFont(font)
        self.raspi_CPU.setAlignment(QtCore.Qt.AlignCenter)
        ...
        self.cadreDataRaspi.setGeometry(QtCore.QRect(-23, 300, 461, 241))
        ...
        self.raspi_Celsius = QtWidgets.QLabel(self.centralwidget)
        self.raspi_Celsius.setGeometry(QtCore.QRect(190, 446, 161, 51))
        font = QtGui.QFont()
        font.setPointSize(20)
        font.setBold(True)
        font.setWeight(75)
        self.raspi_Celsius.setFont(font)
        self.raspi_Celsius.setAlignment(QtCore.Qt.AlignCenter)
        self.raspi_Celsius.setObjectName("raspi_Celsius")       
        self.BG.raise_()
