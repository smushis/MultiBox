...
class Ui_MainWindow(object): 
    ...
    def setupUi(self, MainWindow, app):
        ...
        self.raspi_RAM.setGeometry(QtCore.QRect(190, 355, 81, 31))
        font = QtGui.QFont()
        font.setPointSize(20)
        font.setBold(True)
        font.setWeight(75)
        self.raspi_RAM.setFont(font)
        self.raspi_RAM.setAlignment(QtCore.Qt.AlignLeading|QtCore.Qt.AlignLeft|QtCore.Qt.AlignVCenter)
        ...
        self.raspi_CPU.setAlignment(QtCore.Qt.AlignLeading|QtCore.Qt.AlignLeft|QtCore.Qt.AlignVCenter)
        self.raspi_CPU.setObjectName("raspi_CPU")
        self.raspi_temp = QtWidgets.QLabel(self.centralwidget)
        self.raspi_temp.setGeometry(QtCore.QRect(10, 450, 151, 41))
        font = QtGui.QFont()
        font.setPointSize(20)
        font.setBold(True)
        font.setWeight(75)
